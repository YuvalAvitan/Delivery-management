...
public abstract class Package {
	...
	public Package(Priority priority, Address senderAddress,Address destinationAdress) {
		...
		tracking.add(new Tracking( MainOffice.getClock(), null, status, packageID));
	}	
	...
	public void addTracking(Node node, Status status) {
		tracking.add(new Tracking(MainOffice.getClock(), node, status, packageID));
	}
